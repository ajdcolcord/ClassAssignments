...
public class BuddyListTest extends TestCase {
    ...
    /** test the countHasBeenSeen method */
    public void testCountHasBeenSeen() {
        initBuddies();
        assertEquals(this.hank.countHasBeenSeen(this.l1), 2);
        assertEquals(this.ann.countHasBeenSeen(this.l1), 1);
        assertEquals(this.gabi.countHasBeenSeen(this.l2), 3);
    }
}
